        ...
        <div data-server-rendered="true" id="__nuxt"><!---->
            <div id="__layout">
                <div class="layout is-supernova-theme">
                    <button type="button" class="btn-logo btn-logo_static">
                        <svg width="0.9482758620689655em" height="1em" viewBox="0 0 165 174" class="btn-logo__icon">
                            <defs>
                                <polygon id="15bba6b8-baf3-739a-87d6-b02af2ab97e2"
                                    ...
                                    <g transform="translate(1244.000000, 571.000000)">
                                        <g>
                                            ...
                                            <g transform="translate(0.000000, 0.452160)">
                                                <mask id="bd5090de-0e6d-9e0f-a62a-5af488a4acc5" fill="white">
                                                    <use xlink:href="#15bba6b8-baf3-739a-87d6-b02af2ab97e2"></use>
                                                </mask>
                                                <path d="M87.3774048,30.1196896 C86.4140447,24.9925694 84.7573246,20.0130491 82.3424445,15.3553688 C80.2177244,11.2578486 77.4774042,7.3849684 73.903324,4.42360824 C69.8871638,1.09504806 64.5490835,-0.19087201 59.3722832,0.411048022 C58.7962832,0.478008026 58.1907632,0.582408032 57.7450832,0.953208052 C56.5844431,1.9187281 57.2504431,3.77272821 57.9258032,5.12272828 C63.9608435,17.1985689 63.4683635,31.8844097 58.4809232,44.4289704 C53.4942029,56.9735311 44.3775624,67.5373717 33.9433219,76.1017722 C23.5083613,84.6661726 11.7226806,91.403933 0.00036000002,98.0984934 C15.8022009,122.074495 31.6033217,146.049776 47.4051626,170.024337 C48.0366026,170.984097 48.7249227,171.990657 49.7739627,172.455057 C50.5414828,172.794897 51.4083628,172.800657 52.2471629,172.799937 C69.5473238,172.792737 86.8489247,172.784817 104.149086,172.777617 C87.6589248,150.114896 71.1680439,127.452175 54.678603,104.788734 C67.5450037,93.8886531 78.5386843,80.3296124 84.2850046,64.4766515 C88.2435648,53.5549709 89.5100449,41.4740903 87.3774048,30.1196896"
                                                      fill="currentColor"
                                                      mask="url(#bd5090de-0e6d-9e0f-a62a-5af488a4acc5)"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                                    ...
                                    <div class="event-details__inner">
                                        <div class="event-details__box">
                                            <ul class="event-details__controls">
                                                <li class="event-details__controls-item"><a
                                                            href="https://www.google.com/maps/place/Reykjavik+Center/@64.1462975567853,-21.9383199810114,18z"
                                                            target="_blank" rel="noopener noreferrer"
                                                            class="btn-icon"><i
                                                                class="btn-icon__figure icon icon-marker"></i> <span
                                                                class="btn-icon__text"></span></a></li>
                                                <li class="event-details__controls-item"><a
                                                            href="/event?id=5d547f0a9c07070551c0d108"
                                                            class="btn-icon nuxt-link-active"
                                                            to="/event?id=5d547f0a9c07070551c0d108"><i
                                                                class="btn-icon__figure icon icon-angle-left"></i> <span
                                                                class="btn-icon__text">Go to previous event</span></a>
                                                </li>
                                                <li class="event-details__controls-item"><a
                                                            href="/event?id=5ab62c779c07074e40a239f0"
                                                            class="btn-icon nuxt-link-active"
                                                            to="/event?id=5ab62c779c07074e40a239f0"><i
                                                                class="btn-icon__figure icon icon-angle-right"></i>
                                                        <span class="btn-icon__text">Go to next event</span></a></li>
                                                <li class="event-details__controls-item"><a href="/"
                                                                                            class="btn-icon nuxt-link-active"
                                                                                            to="/"><i
                                                                class="btn-icon__figure icon icon-close"></i> <span
                                                                class="btn-icon__text">Go to event list</span></a></li>
                                            </ul>
                                            <div class="event-details__box-in">
                                                <div class="event-details__main"><img
                                                            src="https://hvirfill.reykjavik.is//images/<?=$event->image_id;?>_large.jpg"
                                                            alt="main image" class="event-details__img">
